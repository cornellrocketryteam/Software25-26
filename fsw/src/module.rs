...
use embassy_rp::peripherals::{
    DMA_CH0, DMA_CH1, DMA_CH2, DMA_CH3, DMA_CH4, FLASH, I2C0, PIN_0, PIN_1, PIN_2, PIN_3, PIN_4, PIN_21, PIN_30, PIN_31, PIN_36, PIN_39, PIN_40, PIN_47, PWM_SLICE8, SPI0, UART0, USB};
...
pub fn init_mav(
    ...
    // For 150 MHz system clock (RP2350) -> 330 Hz Servo frequency:
    // divider = 150
    // top = 3030
    config.top = 3030;
    config.divider = 150.into();
