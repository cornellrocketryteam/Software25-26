//! Hardware configuration constants and pin assignments
//!
//! This module contains all pin numbers, frequencies, and hardware configuration
//! values used throughout the flight software.
...
/// Onboard LED pin (GPIO 25 on Raspberry Pi Pico)
