...
const REG_OUT_X1: u8 = 0x01; //x-axis data middle 
const REG_OUT_X2: u8 = 0x06; //x-axis data low 

const REG_OUT_Y0: u8 = 0x02;//y-axis data high 
const REG_OUT_Y1: u8 = 0x03;//y-axis data middle 
const REG_OUT_Y2: u8 = 0x07;//y-axis data low 

const REG_OUT_Z0: u8 = 0x04;//z-axis data high 
const REG_OUT_Z1: u8 = 0x05;//z-axis data middle 
const REG_OUT_Z2: u8 = 0x08;//z-axis data low
