...
fn main() -> Result<()> {
    ...
    loop {
        ...
        if sample_count % 50 == 1 {
            println!("\n{:-<140}", "");
            println!(
                "{:>6} | {:>8} | ADC1 (0x{:02X}) - Raw Values & Voltages          | ADC2 (0x{:02X}) - Raw Values & Voltages",
                "Sample", "Rate", ADC1_ADDR, ADC2_ADDR
            );
            println!(
                "{:>6} | {:>8} | {:>6} {:>7} | {:>6} {:>7} | {:>6} {:>7} | {:>6} {:>7} | {:>6} {:>7} | {:>6} {:>7} | {:>6} {:>7} | {:>6} {:>7}",
                "",
                "(SPS)",
                "Ch0",
                "V",
        ...
        // Print the readings
        println!(
            "{:>6} | {:>8.1} | {:>6} {:>7.3} | {:>6} {:>7.3} | {:>6} {:>7.3} | {:>6} {:>7.3} | {:>6} {:>7.3} | {:>6} {:>7.3} | {:>6} {:>7.3} | {:>6} {:>7.3}",
            sample_count,
            sps,
            adc1_raw[0],
            adc1_volts[0],
