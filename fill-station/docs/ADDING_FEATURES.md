...
impl Hardware {
    ...
    pub async fn new() -> Result<Self> {
        ...
        let ig1 = Igniter::new(&chip0, 39, &chip0, 38).await?;
        let ig2 = Igniter::new(&chip1, 42, &chip0, 40).await?;
...
impl Hardware {
    ...
    pub async fn new() -> Result<Self> {
        ...
        // Initialize valves on GPIO chip 0 pins 20 and 21
        let valve_lox = Valve::new(&chip0, 20, "LOX").await?;
        let valve_fuel = Valve::new(&chip0, 21, "Fuel").await?;
